...
function choose(x) {
    ...
    .then(data => {
        if (x == 0) {
            document.getElementById("player_choice").innerHTML = "El jugador eligión PIEDRA.";
        } else if (x == 1) {
            document.getElementById("player_choice").innerHTML = "El jugador eligión PAPEL.";
        } else {
            document.getElementById("player_choice").innerHTML = "El jugador eligión TIJERA.";
        }
